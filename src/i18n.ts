...
export const appCopy: Record<Language, AppCopy> = {
  zh: {
    ...
    connected: '已连接，可以互相发送拥抱和喝水', waitingForInvite: '等待 TA 粘贴邀请码', connectionRetry: '暂时无法连接，稍后会自动重试',
  ...
  en: {
    ...
    connected: 'Connected — you can send hugs and water', waitingForInvite: 'Waiting for your partner to paste the invite', connectionRetry: 'Unable to connect right now. Retrying automatically.',
