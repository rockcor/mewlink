...
Open `mewlink-pet-animation-master.aseprite` in Aseprite. It contains 508 frames and 53 named tags.
...
- Every ordered state change has its own twelve-frame `transition-<from>-<to>` tag lasting 4.8 seconds
